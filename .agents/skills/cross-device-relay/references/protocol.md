...
4. In tracked mode, run `git pull --ff-only`; in detached mode, preview and pull relay state when another authoring computer may have worked since this clone was last active.
...
6. Release the baton. In tracked mode, commit the ledger with the product work and push the product branch. In detached mode, push relay state separately.
